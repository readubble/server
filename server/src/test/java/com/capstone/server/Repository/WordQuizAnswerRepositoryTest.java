...
class WordQuizAnswerRepositoryTest {
    ...
    @Test
    void findByTbUserIdAndTbWordQuizNo_test(){
        wordQuizAnswerRepository.save(wordQuizAnswer1);
        wordQuizAnswerRepository.save(wordQuizAnswer3);
        Optional<WordQuizAnswer> result_1 = wordQuizAnswerRepository.findByTbUserIdAndTbWordQuizNo("test123", 1);
        Optional<WordQuizAnswer> result_2 = wordQuizAnswerRepository.findByTbUserIdAndTbWordQuizNo("test123", 2);
        assertThat(result_1.isPresent()).isTrue();
        assertThat(result_1.get().getTbWordQuizNo()).isEqualTo(1);
